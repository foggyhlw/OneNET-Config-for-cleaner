...
# for Cleaner
datastream_ids = ['cmd', 'off_threshold', 'low_threshold',
                  'medium_threshold', 'high_threshold', 'pm01', 'pm25', 'pm10']
...
def add_datapoints(api_key, device_id, off=10, low=50, medium=100, high=160):
    ...
    data = {'datastreams': [{'id': 'off_threshold', 'datapoints': [{"value": off}]},
                            {'id': 'low_threshold',
                                'datapoints': [{"value": low}]},
                            {'id': 'medium_threshold',
                                'datapoints': [{"value": medium}]},
                            {'id': 'high_threshold',
                                'datapoints': [{"value": high}]},
